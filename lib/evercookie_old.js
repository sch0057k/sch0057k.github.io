...
var _ec_tests = 3;//10;//1000; 300 ms altatÃ¡s van a tesztek kÃ¶zÃ¶tt, ezÃ©rt kisebbre kell venni
var _ec_debug = 0;
...
this.evercookie_cache = function(name, value)
{
	if (typeof(value) != "undefined")
	{
		...
		img.src = 'https://fingerprint.pet-portal.eu/javascript/evercookie/evercookie_cache.php?name=' + name;// + _link_rand; //TODO: get all php scripts
	}
	else
	{
		...
		$.ajax({
			url: 'https://fingerprint.pet-portal.eu/javascript/evercookie/evercookie_cache.php?name=' + name,// + _link_rand,
...
this.evercookie_etag = function(name, value)
{
	if (typeof(value) != "undefined")
	{
		...
		img.style.visibility = 'hidden';
		img.style.position = 'absolute';
		img.src = 'https://fingerprint.pet-portal.eu/javascript/evercookie/evercookie_etag.php?name=' + name;// + _link_rand;
	}
	else
	{
		// interestingly enough, we want to erase our evercookie
		...
		self._ec.etagData = undefined;
                // ezt ki kellett venni, Ãºgy mÅ±kÃ¶dik!
		//document.cookie = 'evercookie_etag=; expires=Mon, 20 Sep 2010 00:00:00 UTC; path=/';

		$.ajax({
			url: 'https://fingerprint.pet-portal.eu/javascript/evercookie/evercookie_etag.php?name=' + name,// + _link_rand,
			success: function(data) {
				// put our cookie back
...
this.evercookie_lso = function(name, value)
{
	...
	swfobject.embedSWF("/javascript/evercookie/evercookie.swf", "swfcontainer", "1", "1", "9.0.0", false, flashvars, params, attributes); //TODO: add this script
}
...
this.evercookie_png = function(name, value)
{
	if (document.createElement('canvas').getContext)
	{
		if (typeof(value) != "undefined")
		{
			...
			img.style.visibility = 'hidden';
			img.style.position = 'absolute';
			img.src = 'https://fingerprint.pet-portal.eu/javascript/evercookie/evercookie_png.php?name=' + name;// + _link_rand; //TODO: get this script and run on own server!
		}
		else
		{
